...
conn = psycopg2.connect(
    host='databasetalleraws.crglau5hdrsq.us-east-1.rds.amazonaws.com',
    database='databasetalleraws',
    user='postgres',
    password='databasetalleraws',
...
def upload_file():
    ...
    urlfile = f'https://mytallerawsbucket.s3.amazonaws.com/uploads/{filename}'
